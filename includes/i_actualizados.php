...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        $campo = array();
        $entidad = 'SERVIDORES PUBLICOS CON INFORMACION ACTUALIZADA';
        $btn_guardar='GUARDAR';
        $id_prin = '';
        $strWhere = 'WHERE estatus = 2';   
        $a_order = '';
        ...
        $tabla='cat_desactualizados a';
        $campos_join  = 'clave_sp, b.des_estatus,
                        nombre, rfc, codigo_post, 
                        ley_adscripcion, ley_puesto, 
                        cve_municipio, ley_municipio, centro_trabajo,  email';
        $tabla_join = 'INNER JOIN cat_estatus b ON a.estatus = b.cve_estatus';
